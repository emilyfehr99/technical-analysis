                ...
                <div className="mt-6 pt-4 border-t border-slate-100">
                    <div className="flex items-center justify-between">
                        ...
                        <span className={`text-xs font-bold px-2 py-1 rounded-md border ${
                            data.marketCondition === 'TRENDING' ? 'bg-blue-50 text-blue-600 border-blue-100' :
                            ...
                            <div key={i} className="group">
                                <div className="flex justify-between items-end mb-1">
                                    <span className={`text-xs font-bold uppercase tracking-wider ${
                                        scenario.name === 'BULL_CASE' ? 'text-emerald-600' : 
                                ...
                                <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden mb-2">
                                    <div 
                                        className={`h-full rounded-full transition-all duration-1000 ease-out ${
                                            scenario.name === 'BULL_CASE' ? 'bg-emerald-400' : 
                ...
                <div className="space-y-4">
                    ...
                    <div className="mt-4 p-3 bg-slate-50/50 rounded-xl border border-slate-100/50">
                        ...
                        <span className={`text-sm font-bold ${
                            data.technicalAnalysis.trend === 'BULLISH' ? 'text-emerald-600' :
                    ...
                    <div className="mb-4">
                         ...
                         <div className="flex items-center gap-2">
                             <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide border ${
                                 data.pattern?.type === 'REVERSAL' ? 'bg-purple-500/20 text-purple-200 border-purple-500/30' :
